...
Coffee Insights dashboard: KPIs, sales trends, peak days and hours, a day-by-hour heatmap, roast mix and best sellers.
Click any chart to drill into that slice. It runs on generated demo data with a single swap point, getSales() in src/lib/sales-data.ts, for a real dataset.
